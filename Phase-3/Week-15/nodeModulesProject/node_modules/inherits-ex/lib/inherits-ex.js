...
InheritsEx.requireClass = _getClassByName.getClassByName;
InheritsEx.scope = {};
...
InheritsEx.execute = function (ctor, superCtors, aScope, aValues) {
  ...
  const result = (0, _inherits.inherits)(ctor, superCtors);
  if (result && !isStrCtor) {
